    ...
    <div className="min-h-screen bg-gradient-to-br from-[#6A23F5] via-[#8B4FFF] to-[#A855F7] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <p className="text-white/80">Join TaxBreeze for hassle-free tax filing</p>
        </motion.div>
        ...
        >
          <Card className="border-0 shadow-2xl backdrop-blur-sm bg-white/95">
            <CardHeader>
              <h2 className="text-center text-[#1A1A1A] text-2xl">Sign Up</h2>
            </CardHeader>
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  <label htmlFor="name" className="block font-medium text-sm text-gray-700">Full Name</label>
                  <div className="relative mt-2">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#6F6F6F] w-5 h-5" />
                    <input
                      id="name"
                      type="text"
                      value={formData.name}
                ...
                >
                  <label htmlFor="phone" className="block font-medium text-sm text-gray-700">Phone Number</label>
                  <div className="relative mt-2">
                    <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#6F6F6F] w-5 h-5" />
                    <input
                      id="phone"
                      type="tel"
                ...
                >
                  <label htmlFor="confirmPassword" className="block font-medium text-sm text-gray-700">Confirm Password</label>
                  <div className="relative mt-2">
                    <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#6F6F6F] w-5 h-5" />
                    <input
                      id="confirmPassword"
                ...
                >
                  ...
                  <span className="text-sm text-[#6F6F6F]">
                    I agree to the{' '}
                    <Link to="/terms" className="text-[#6A23F5] hover:underline">
                      Terms of Service
                    </Link>{' '}
                    and{' '}
                    <Link to="/privacy" className="text-[#6A23F5] hover:underline">
                      Privacy Policy
                    </Link>
                  </span>
                </motion.div>
              ...
              >
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-[#6F6F6F]">Or sign up with</span>
                </div>
              </motion.div>
