          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <label htmlFor="name" className="block mb-1 font-medium text-[#1A1A1A]">Full Name</label>
                  <input
                    id="name"
                    type="text"
                    value={formData.name}
                ...
                >
                  <label htmlFor="phone" className="block mb-1 font-medium text-[#1A1A1A]">Phone Number</label>
                  <input
                    id="phone"
                    type="tel"
                ...
                >
                  <label htmlFor="email" className="block mb-1 font-medium text-[#1A1A1A]">Email Address</label>
                  <input
                    id="email"
                    type="email"
                ...
                >
                  <label htmlFor="service" className="block mb-1 font-medium text-[#1A1A1A]">Service Interested In</label>
                  <select
                    id="service"
                    value={formData.service}
                    onChange={(e) => setFormData({ ...formData, service: e.target.value })}
                    required
                    className="mt-2 rounded-xl h-12 w-full"
                  >
                ...
                >
                  <label htmlFor="message" className="block mb-1 font-medium text-[#1A1A1A]">Message</label>
                  <textarea
                    id="message"
