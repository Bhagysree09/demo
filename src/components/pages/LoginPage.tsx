      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
          <motion.div
            ...
            className="max-w-md"
          >
            <h1 className="text-5xl mb-6">Welcome Back to TaxBreeze</h1>
            <p className="text-xl text-white/90 mb-8">
              Your trusted partner for hassle-free tax filing and compliance services
            </p>
            ...
            >
              <p className="text-sm italic">
                "TaxBreeze made my tax filing so easy! The entire process was smooth and the CA was very helpful."
              </p>
              <p className="mt-3">- Rajesh Kumar, Software Engineer</p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white">
        ...
        >
          ...
          {/* <div className="text-center mb-8">
            ...
            <h2 className="text-3xl text-[#1A1A1A] mb-2">Sign In</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#6A23F5] focus:ring-[#6A23F5]" />
